    ...
    data () {
      return {
        playlist: [
          ...
          {title: "Monster(Amapiano)", artist: "Dj Sxhosana", howl: null, display: true},
          {title: "Laphum'ilanga(OriginalMix)", artist: "Dj Sxhosana & MhlangaRox", howl: null, display: true    }, 
          {title: "Undiqoma_NiniMain_Mix", artist: "MhlangaRox__Dj_Sxhosana", howl: null, display: true    }, 
